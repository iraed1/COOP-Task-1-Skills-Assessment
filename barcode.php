...
<style>
  ...
  .badge .num { margin-top:10px; font-size:13px; color:#555; direction:ltr; }
...
<body>
  <div class="badge">
    ...
    <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&margin=8&data=<?= urlencode($employee['employee_number']) ?>" alt="QR Code">
